...
.. figure:: _static/scout_mini/scout_mini.png
  :width: 100%
  :align: center
...
.. figure:: _static/scout_mini/scout_mini_overview.png
  :width: 100%
  :align: center
  :figclass: align-centered
  :alt: overview
...
* **Power on:** 로봇 전면의 조명이 켜집니다. 조명은 RC 조종기와 통신 명령을 통해서 
  제어할 수 있습니다.
...
.. figure:: _static/scout_mini/scout_mini_electrical_interface.png
  :width: 100%
  :align: center
  :figclass: align-centered
...
.. image:: _static/scout_mini/scout_mini_aviation_connector.png
  :width: 25%
  :align: left
...
SWB 스위치를 중간 위치에 있으면 원격 제어 모드가 활성화되고, 상단 위치에 있으면 명령 모드가
활성화됩니다.
...
.. figure:: _static/scout_mini/scout_mini_coordinate.png
  :width: 90%
  :align: center
  :figclass: align-centered
  :alt: coordinate
...
.. figure:: _static/scout_mini/scout_mini_dimensions.png
  :width: 90%
  :align: center
  :figclass: align-centered
  :alt: dimensions
...
.. note::
  ...
  Scout Mini의 경우에는, 조명이 로봇의 전면에만 조명이 설치되어 있기 때문에 후면 조명 인터페이스는
  동작하지 않습니다.
...
.. figure:: _static/scout_mini/scout_mini_rviz.png
  :width: 100%
  :align: center
  :figclass: align-centered
  :alt: rviz
